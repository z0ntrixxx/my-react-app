      ...
      <div className="features__content">
        ...
        <div className="features__grid">
          <div className="feature">
            ...
            <p className="feature__description">Выбираете что угодно.<br /> Выбор всегда остается за Вами.</p>
          </div>
          <div className="feature">
          ...
          <div className="feature">
            ...
            <p className="feature__description">Обращайтесь к Нам за<br /> уникальными инструментами.</p>
          </div>
        </div>
      </div>
    </section>
